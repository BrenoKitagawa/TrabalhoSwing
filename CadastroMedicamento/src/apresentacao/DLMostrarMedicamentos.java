...
public class DLMostrarMedicamentos extends JDialog {
    ...
    public DLMostrarMedicamentos(ControlaMedicamento cm) {
        ...
        String[] colunas = {"ID" , "Nome","Data de fabricação","Data de validade","Principio ativo" , "unidadeFarmaco","registroMs"};
        ...
        for(Medicamento medicamentos : cm.mostrarMedicamentos()){
            Object[] dadosMedicamentos ={medicamentos.getId(),medicamentos.getNome(),
                    medicamentos.getDataFabricacao().format(formatado),
                    medicamentos.getDataValidade().format(formatado),
                    medicamentos.getPrincipioAtivo(),
                    medicamentos.getUnidadeFarmaco(),
                    medicamentos.getRegistroMs(),};
